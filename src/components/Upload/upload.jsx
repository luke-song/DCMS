      ...
      <Container mt={50} maxW="90%" display="flex">
        <Flex direction="row" w={'95%'}>
          <VStack align="flex-start">
            ...
            <Heading size="lg">
              Imagine a place where your contents do not ever&nbsp;
              <span style={{ color: '#FF6467' }}>disappear.</span>
            </Heading>
            <br />
            <Heading size="lg">
              On cms, it will be stored on{' '}
              <span style={{ color: '#FF6467' }}>block-chain.</span>
            </Heading>
          </VStack>
              ...
              <Box alignItems={'center'}>
                ...
                <Text color="#FF6467" size="sm">
                  <a href="https://mumbai.polygonscan.com/">
                    Go to Polygon Scan to see your data on chain [click]
                  </a>
                </Text>
              </Box>
            </VStack>
